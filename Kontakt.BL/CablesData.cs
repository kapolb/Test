...
namespace Kontakt.BL
{
    ...
    {
        public CablesData(string connectionString, string usages2010Path, int filterDataId, int filterOrderedId, int filterOnStockId)
            : base(connectionString, usages2010Path, filterDataId, filterOrderedId, filterOnStockId)
        {
        }
    ...
    public class CablesDataFiltered : CablesData
    {
        ...
        public CablesDataFiltered(string connectionString, string usages2010Path, int filterDataId, int filterOrderedId, int filterOnStockId)
            : base(connectionString, usages2010Path, filterDataId, filterOrderedId, filterOnStockId)
        {
        }
